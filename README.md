...
``` r
The code, text, tests are all adapted or copied from DSCI_310 "The whole game" chapter of the R Packages book https://r-pkgs.org/whole-game.html#check. The original worked example can be found using command below
...
``` r
# install.packages("devtools")
devtools::install_github("chris-ckh/regexcite")
```
